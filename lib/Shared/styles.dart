...
const contrastText = TextStyle(color: Colors.green, fontFamily: 'Poppins');
const contrastTextBold = TextStyle(
    color: primaryColor, fontFamily: 'Poppins', fontWeight: FontWeight.w600);
const contrastTextBold2 = TextStyle(
    color: darkBlue, fontFamily: 'Poppins', fontWeight: FontWeight.w600);
...
const accountNameText = TextStyle(
...
const pagePlateDecoration = BoxDecoration(
    color: white,
    boxShadow: [
      BoxShadow(
          color: Color.fromRGBO(0, 0, 0, .1),
